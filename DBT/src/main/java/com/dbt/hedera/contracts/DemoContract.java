package com.dbt.hedera.contracts;
...
import com.dbt.hedera.file.FileCreate;
...
import com.dbt.hedera.utilities.HederaUtilities;
...
public final class DemoContract {
	...
	public static void getContract() {
		...
		txQueryDefaults = HederaUtilities.getTxQueryDefaults();
		...
		if (account != null) {
			...
			// get file contents
			try {
				InputStream is = DemoContract.class.getResourceAsStream("/main/resources/DBT_SC.bin");
				...
				if (contract != null) {
					...
					if (contract != null) {
						...
						// call
						final String SC_SET_ABI = "{ \"constant\": false, \"inputs\": [ { \"name\": \"newMessage\", \"type\": \"bytes32\" } ], \"name\": \"setMessage\", \"outputs\": [], \"payable\": false, \"stateMutability\": \"nonpayable\", \"type\": \"function\" }";
						long gas = 250000;
						long amount = 14;
						...
						// call local
						String SC_GET_ABI = "{ \"constant\": true, \"inputs\": [], \"name\": \"getMessage\", \"outputs\": [ { \"name\": \"\", \"type\": \"bytes32\" } ], \"payable\": false, \"stateMutability\": \"view\", \"type\": \"function\" }";
